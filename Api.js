    ...
    async hlAddClient(data, sales) {
        ...
        let content = {
            ...
            [
                ...
                {id: 'jZE5gPqTELn2ICqQGmCk', key: 'creation_date', field_value: data.Id},
                {id: 'jZE6gPqTELn2ICqQGmCk', key: 'birth_date', field_value: data.BirthDate},
                {id: 'jZE7gPqTELn2ICqQGmCk', key: 'client_credit_card', field_value: data.ClientCreditCard},
                {id: 'jZE8gPqTELn2ICqQGmCk', key: 'send_account_texts', field_value: data.SendAccountTexts},
                {id: 'jZE9gPqTELn2ICqQGmCk', key: 'send_promotional_emails', field_value: data.SendPromotionalEmails},
                {id: 'jZE0gPqTELn2ICqQGmCk', key: 'send_promotional_texts', field_value: data.SendPromotionalTexts},
                {id: 'jZE1gPqTELn2ICqQGmCk', key: 'send_schedule_emails', field_value: data.SendScheduleEmails},
                {id: 'jZE2gPqTELn2ICqQGmCk', key: 'send_schedule_texts', field_value: data.SendScheduleTexts},
