    ...
    async hlAddClient(data) {
        ...
        let content = {
            ...
            [
                ...
                {key: 'send_account_texts', field_value: data.SendAccountTexts},
                {key: 'send_promotional_emails', field_value: data.SendPromotionalEmails},
                {key: 'send_promotional_texts', field_value: data.SendPromotionalTexts},
                {key: 'send_schedule_emails', field_value: data.SendScheduleEmails},
                {key: 'send_schedule_texts', field_value: data.SendScheduleTexts},
                {key: 'salesurl', field_value: `https://dev1.htt.ai/client-sales?id=${data.Id}&period=90`},
            ],
            source: 'public api',
